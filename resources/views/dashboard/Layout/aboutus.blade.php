...
<div class="about-us">
    <div class="about-container">
        ...
        <p class="about-p">We are a website specialized in selling and booking cinema tickets, dedicated to providing an
            ...
            opportunity to access the latest movies and series of all kinds, at competitive prices and high quality.</p>
    </div>
    ...
    <div class="about-container">
        ...
        <p class="about-p">Because we are considered the best site in history to help you book cinema tickets with the
            ...
            booking cinema tickets where you will find all types of movies and series that you have always wanted to
            watch.</p>
    </div>
    ...
    <div class="about-container">
        ...
        <ul>
            ...
            <li class="about-li">Movie Information: Our site offers comprehensive information about the movies you want
                to watch, including reviews, ratings, and plot summaries, helping you choose the best movie to watch.
            </li>
        </ul>
    </div>
</div>
